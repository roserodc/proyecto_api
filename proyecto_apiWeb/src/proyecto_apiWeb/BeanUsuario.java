...
//			managerCarrera.insertar(carrera);
			managerUsuario.insertar(usuario, idNivel, idRol, idCarrera, idClub);
			lista = managerUsuario.findAll();
			usuario = new Usuario();
...
//			managerCarrera.insertar(carrera);
	...
	public List<SelectItem> getListaCarreraSI() {
		...
		for (Carrera c : listadoClientes) {
			SelectItem item = new SelectItem(c.getCaId(), c.getCaDescripcion());
			listadoSI.add(item);
		}
		return listadoSI;
	}
	...
	public List<SelectItem> getListaClubSI() {
		...
		for (Club c : listadoClientes) {
			SelectItem item = new SelectItem(c.getCluId(), c.getCluDescripcion());
			listadoSI.add(item);
		}
		return listadoSI;
	}
	...
	public List<SelectItem> getListaNivelSI() {
		...
		for (Nivel c : listadoClientes) {
			SelectItem item = new SelectItem(c.getNiId(), c.getNiDescripcion());
			listadoSI.add(item);
		}
		return listadoSI;
	}
	...
	public List<SelectItem> getListaRolSI() {
		...
		for (Role c : listadoClientes) {
			SelectItem item = new SelectItem(c.getRId(), c.getRDescripcion());
			listadoSI.add(item);
		}
		return listadoSI;
	}
